<!-- 
Complete example of custom exportButton slot usage
This file shows different ways to use the new slot
-->
<template>
    <div class="space-y-8 p-6">
        <h1 class="text-3xl font-bold text-gray-900">Custom Export Button Examples</h1>

        <!-- Example 1: Simple button with custom styling -->
        <section>
            <h2 class="text-xl font-semibold mb-4">1. Simple Custom Button</h2>
        ...
        <!-- Example 2: Button with confirmation -->
        <section>
            <h2 class="text-xl font-semibold mb-4">2. Button with confirmation</h2>
        ...
        <!-- Example 3: Dropdown menu with options -->
        <section>
            <h2 class="text-xl font-semibold mb-4">3. Dropdown menu with options</h2>
        ...
        <!-- Example 4: Button with download counter -->
        <section>
            <h2 class="text-xl font-semibold mb-4">4. Button with counter</h2>
...
const exportExcel = () => {
    alert('Custom Excel export started!');
    showDropdown.value = false;
};

const exportPDF = () => {
    alert('Custom PDF export started!');
    showDropdown.value = false;
};

const trackAndExport = (exportUrl) => {
    downloadCount.value++;
    console.log(`Download #${downloadCount.value} started`);
    window.location.href = exportUrl;
};
</script>
